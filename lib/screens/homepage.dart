...
//     try {
//       final response = await http.get(
//         Uri.parse("http://192.168.1.6:8000/api/CategoryView"),
//       );
...
//     try {
//       final response = await http.get(
//         Uri.parse("http://192.168.1.6:8000/api/search?keyword=$keyword"),
//       );
...
//   /// ✅ Search results -> direct open vendor page
...
//                 return Image.asset("assets/images/custompackageimage.jpg");
//               },
//             );
...
//                           headerImage: "assets/images/custompackageimage.jpg",
//                           vendor: vendor,
//                         ),
//                   ),
//                 );
...
//                                     ? imageStr
//                                     : "assets/images/marrymate.png",
//                             vendor: null, // Premium service pe vendor null
//                           ),
//                     ),
//                   );
//                 },
...
//   //  Updated searchVendors with headers
//   Future<void> searchVendors() async {
//     final keyword = _searchController.text.trim();
//     if (keyword.isEmpty) {
//       setState(() {
