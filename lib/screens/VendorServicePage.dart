...
//                                     backgroundColor:
//                                         Colors
//                                             .deepOrange, // ✅ set background color here
//                                   ),
//                                 );
//                               } else {
//                                 ScaffoldMessenger.of(context).showSnackBar(
            ...
            return Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 20),
                  ElevatedButton(
                    onPressed: (isOneDay && startDate != null) ||
                            (!isOneDay &&
                                startDate != null &&
                                endDate != null)
                        ? () async {
                            final res = await http.post(
                              ...
                              body: {
                                ...
                                'end_date':
                                    (endDate ?? startDate).toString().split(" ")[0],
                              },
                            );
                            ...
                            if (responseJson['status'] == 'available') {
                              setState(() {
                                allItems[index].startDate = startDate;
                                allItems[index].endDate = endDate ?? startDate;
                                allItems[index].isAddedToCart = true;
                                if (!globalCartItems.contains(allItems[index])) {
                                  globalCartItems.add(allItems[index]);
                                }
                              });
                              saveCartToPrefs();
                              ...
                              // ✅ Top success message
                              Flushbar(
                                message: '${allItems[index].serviceType} added to cart!',
                              ...
                              // ❌ Top error message
                              Flushbar(
                                message: responseJson['message'] ?? "Date unavailable",
                                ...
                                child: ListView.builder(
                                  ...
                                  itemBuilder: (context, imgIndex) {
                                    return Padding(
                                      ...
                                      child: GestureDetector(
                                        onTap: () =>
                                            showImagePopup(item.images, imgIndex),
                                        child: ClipRRect(
                                          borderRadius: BorderRadius.circular(10),
                                          child: Image.network(
                                            item.images[imgIndex],
                            ...
                            Row(
                              ...
                              children: [
                                ElevatedButton.icon(
                                  ...
                                  style: ElevatedButton.styleFrom(
                                    backgroundColor: item.isAddedToCart
                                        ? Colors.teal
                                        : Colors.deepOrange,
                                    shape: RoundedRectangleBorder(
                                      borderRadius: BorderRadius.circular(20),
