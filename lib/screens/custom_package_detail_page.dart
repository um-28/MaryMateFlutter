...
//       {}; // NEW MAP to track manual user selection
...
//   Future<void> checkDateAvailability(String uniqueKey, int vendorId) async {
...
//   void showDatePickerModal(String uniqueKey, int vendorId) {
...
//                             userHasSelectedDateMap[uniqueKey] =
//                                 true; // user selected
//                           });
//                           Navigator.pop(context);
//                           checkDateAvailability(uniqueKey, vendorId);
//                         },
//                         style: ElevatedButton.styleFrom(
//                           backgroundColor: Colors.deepOrange,
//                         ),
...
//                   backgroundColor: Colors.deepOrange,
//                 ),
//                 onPressed: () => showDatePickerModal(uniqueKey, vendorId),
//                 child: const Text("Select"),
//               ),
//             ),
//           ],
...
class CustomPackageDetailPage extends StatefulWidget {
  ...
  const CustomPackageDetailPage({super.key, required this.packageId, required packageData});
...
class _CustomPackageDetailPageState extends State<CustomPackageDetailPage> {
  ...
  Widget buildServiceOrPackageCard(dynamic item, String imageFolder) {
    final vendorId = item['vendor_id'];
    final id = item['id'] ?? item['sp_id'];
    final String type = imageFolder == 'service-image' ? 'service' : 'package';
