...
class _VendorAvailabilityPageState extends State<VendorAvailabilityPage> {
  ...
  Future<void> fetchAvailability() async {
    ...
    final url = Uri.parse(
      "http://192.168.1.4:8000/api/VendorAvailabilityView?user_id=$userId",
    );
  ...
  Future<void> toggleStatus() async {
    ...
    final url = Uri.parse(
      "http://192.168.1.4:8000/api/VendorAvailability/status?user_id=$userId",
    );
...
class _EditAvailabilityPageState extends State<EditAvailabilityPage> {
  ...
  Future<void> updateAvailability() async {
    ...
    final url = Uri.parse(
      "http://192.168.1.4:8000/api/UpdateVendorAvailability",
    );
