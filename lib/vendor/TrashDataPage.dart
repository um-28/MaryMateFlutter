...
//       Uri.parse('http://192.168.1.3:8000/api/ServiceTrash?user_id=$userId'),
//     );
...
//     final response = await http.get(
//       Uri.parse('http://192.168.1.3:8000/api/ServiceRestore/$serviceId'),
//     );

//     if (response.statusCode == 200) {
//       ScaffoldMessenger.of(context).showSnackBar(
//         const SnackBar(content: Text("Service restored successfully")),
//       );
//       fetchTrashedServices();
//     } else {
//       ScaffoldMessenger.of(context).showSnackBar(
//         const SnackBar(content: Text("Failed to restore service")),
//       );
//     }
//   }

//   Future<void> deleteServicePermanently(String serviceId) async {
//     final response = await http.get(
//       Uri.parse(
//         'http://192.168.1.3:8000/api/ServiceDeletePermanently/$serviceId',
//       ),
//     );

//     if (response.statusCode == 200) {
//       ScaffoldMessenger.of(context).showSnackBar(
//         const SnackBar(content: Text("Service deleted permanently")),
//       );
//       fetchTrashedServices();
//     } else {
//       ScaffoldMessenger.of(
//         context,
//       ).showSnackBar(const SnackBar(content: Text("Failed to delete service")));
//     }
//   }
...
//                                                 final imageUrl =
//                                                     'http://192.168.1.3:8000/service-image/${imageList[index]}';
//                                                 return Padding(
//                                                   padding:
...
class _TrashDataPageState extends State<TrashDataPage> {
  ...
  Future<void> forceDeleteService(String serviceId) async {
    final response = await http.get(
      Uri.parse('http://192.168.1.3:8000/api/ServiceForceDelete/$serviceId'),
    );
