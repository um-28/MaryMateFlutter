...
//     final url = Uri.parse(
//       'http://192.168.1.9:8000/api/BookingDetails?user_id=${widget.userId}',
//     );
...
//           setState(() {
//             serviceBookings = data['data']['service_bookings'] ?? [];
//             packageBookings = data['data']['package_bookings'] ?? [];
//             customBookings = data['data']['custom_package_bookings'] ?? [];
//             isLoading = false;
//           });
//         } else {
