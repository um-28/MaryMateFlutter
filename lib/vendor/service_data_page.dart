...
class _ServiceDataPageState extends State<ServiceDataPage> {
  ...
  void initState() {
    super.initState();
    fetchServiceData(); // Initial load without search
  }

  Future<void> fetchServiceData({String search = ''}) async {
    ...
    final url = Uri.parse(
      '$baseUrl/api/ServiceData?user_id=$userId&search=${Uri.encodeComponent(search)}',
    );
                              ...
                              >.generate(filteredServices.length, (index) {
                                ...
                                return DataRow(
                                  cells: [
                                          ...
                                          ElevatedButton(
                                            onPressed: () async {
                                              final response = await http.get(
                                                Uri.parse(
                                                  '$baseUrl/api/ServiceTrashDelete/${item['service_id']}',
                                                ),
                                              );
                                    ...
                                    DataCell(
                                      Text(item['service_type'] ?? 'No Type'),
                                    ),
